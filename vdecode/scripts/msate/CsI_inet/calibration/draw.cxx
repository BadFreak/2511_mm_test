...
void draw(const float& dataFraction=1.,const std::string& filename=""){
    draw_ped(filename,dataFraction);
    //draw_temp("temp_Calo_cosmic_20250528_1138.root");
}
